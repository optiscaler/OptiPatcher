...
static void CheckForPatch()
{
    ...
    // Tide, Echoes of the End: Enhanced Edition, Supraworld, ROMEO IS A DEAD MAN
             ...
             CHECK_UE(supraworld) || CHECK_UE(sevgame))
    {
    ...
    // Assetto Corsa Rally, SpongeBob SquarePants: Titans of the Tide, Styx: Blades of Greed (Demo), ROMEO IS A DEAD MAN
